...
export const GoogleFormTriggerDialog = ({ open, onOpenChange }: props) => {
  ...
  const webhookUrl = `${baseUrl}/api/webhooks/google-form?id=${id}`;
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              size="icon"
              variant="outline"
              onClick={async () => copyToClipboard(webhookUrl)}
            >
              <CopyIcon className="size-4" />
            </Button>
          </div>
          <div className="rounded-lg bg-muted p-4 space-y-2">
            <h2 className="font-medium text-sm">Setup instructions:</h2>
          ...
          <div className="rounded-lg bg-muted p-4 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              This script includes your webhook URL abd handles form
              submissions.
            </p>
          </div>
          <div className="rounded-lg bg-muted p-4 space-y-2">
